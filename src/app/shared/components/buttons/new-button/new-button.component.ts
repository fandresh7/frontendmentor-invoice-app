...
@Component({
  ...
  template: `<button
    [type]="type"
    (click)="click()"
    class="heading-s-variant text-white bg-theme-primary transition-colors duration-300 flex gap-2 items-center rounded-3xl py-2 pl-2 pr-2 hover:bg-theme-primary-accent">
