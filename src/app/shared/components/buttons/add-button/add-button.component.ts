...
@Component({
  ...
  template: `<button
    [type]="type"
    class="heading-s-variant text-theme-blue bg-[#F9FAFE] hover:text-theme-blue hover:bg-[#DFE3FA] min-w-full flex justify-center items-center gap-2 mx-auto transition-colors duration-500 rounded-3xl pt-[17px] pb-[15px] px-6">
