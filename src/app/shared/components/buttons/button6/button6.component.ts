...
@Component({
  ...
  template: `<button class="mx-auto w-full heading-s flex justify-center items-center gap-2 bg-lightBg text-light3 hover:bg-light1 transition-colors duration-500 rounded-3xl pt-[17px] pb-[15px] px-6">
